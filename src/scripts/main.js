...
document.addEventListener("DOMContentLoaded", () => {
  ...
  tBtn.addEventListener("click", function (e) {
    ...
    document
      .querySelector(".promotion_form_links")
  ...
  allPromotionCLoseBtn.forEach((allPromotionCLoseBtn) => {
    allPromotionCLoseBtn.addEventListener("click", function (e) {
      ...
      document.querySelector("header").classList.remove("promotion_opened");
      document
        .querySelector(".promotion .thanks_form")
        .classList.remove("show");
      document
        .querySelector(".promotion_form")
  ...
  //       "open",
  //       !parentElement.classList.contains("open")
  //     );

  //     parentElement.children[1].classList.toggle(
  //       "show",
  //       !parentElement.children[1].classList.contains("show")
  //     );
  //   });
  // });
  ...
  document
    .querySelector(".section_menu .overlay")
    .addEventListener("click", function () {
      document.querySelector(".section_menu").classList.remove("show");
      document
        .querySelector(".header_actions .hamburg_menu")
  ...
  //   "#services .swiper_titles .title_item"
  // );
  ...
  //       `#services .splide__slide[id="${dataId}"]`
  //     );
